  ...
  return {
    ...
    info: {
      ...
      content: {
        ...
        site: { label: 'Github:', value: 'ffxixslh' },
      },
    },
    skills: {
      title: '个人技能',
      content: [
        '能使用 HTML + CSS 结合 Tailwind CSS、 UnoCSS 等前端技术进行设计稿还原',
        '熟悉 JavaScript，了解 TypeScript，能运用 ES6 、 ES7 等高级语法进行开发',
      ...
      content: [
        {
          ...
          projectContent: ['prj 1', 'prj 2', 'prj 3'],
        },
      ],
    },
    evaluation: {
